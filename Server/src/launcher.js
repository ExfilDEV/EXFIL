...
var launcherSettings = settings.getLauncherSettings();
var data = JSON.parse('{"email":"' + launcherSettings.email + '","password":"' + launcherSettings.password + '","toggle":true,"timestamp":0}');
